    ...
    >
      ...
      <header className="p-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            ...
            <p className="text-sm opacity-75" style={{ color: currentTheme.text }}>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-5xl font-bold mb-6" style={{ color: currentTheme.text }}>
            Welcome to Sahaara
          </h2>
          <p className="text-xl max-w-4xl mx-auto leading-relaxed mb-8" style={{ color: currentTheme.text, opacity: 0.8 }}>
            Your comprehensive mental health companion designed to support students through their academic journey. 
            Find resources, connect with counselors, and build a supportive community in a safe, understanding environment.
          </p>
        </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-6">
            <Settings style={{ color: currentTheme.text }} size={24} className="mr-2" />
            ...
            {Object.entries(themes).map(([key, theme]) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg border-2 ${
                  selectedTheme === key ? 'ring-4 ring-opacity-50' : 'hover:shadow-md'
                }`}
                style={{
                  backgroundColor: theme.primary,
                  color: 'white',
                  borderColor: selectedTheme === key ? theme.secondary : theme.primary,
